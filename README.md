...
## Dependency
* ![jQuery 1.*](https://raw.githubusercontent.com/newmandani/jQuerySlackNotification/master/misc/jquery_ico.gif){:width="50px"} [jQuery](https://cdnjs.com/libraries/jquery/1.12.4) Needed
* ![Slack](https://raw.githubusercontent.com/newmandani/jQuerySlackNotification/master/misc/slack_ico.png){:width="50px"} [Slack](https://slack.com) Needed
